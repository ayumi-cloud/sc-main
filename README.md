...
---------
  ...
  SORRY THE PUBLIC REPOS ARE A MESS AND HALF DONE. WE'RE SPENDING SO MUCH TIME GATHERING IDEAS, RESEARCHING METHODS TO CREATE THE IDEAS, CODING THEM, DEBUG AND TESTING THE CODE AND KEEP REPEATING THE PROCCESS. WE USE SUMMER CMS EVERYDAY AND EVERY 1-2 WEEKS KEEP RELEASING MAJOR UPDATES AND SEVERAL TIMES DAILY MINOR UPDATES! THIS HAS GONE ON FOR OVER A YEAR NOW. WE HOPE TO EXPAND THE CODING TO TEAM AROUND 30 MEMBERS FULL TIME AND RELEASE AN EXCITING CANDIDATE RELEASE IN THE NEAR FUTURE! BEFORE THEN THE PUBLIC DOCS WILL BE FINISHED OFF AND WE WELCOME ALPHA TESTERS. RIGHT NOW WE ARE FOCUSED WITH THE CODING IN THE PRIVATE REPO'S.
  
  DEVELOPMENT IS CURRENTLY BEING FOCUSED ON THE FOLLOWING THREE MODULES:
