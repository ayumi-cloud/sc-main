...
EU-U.S. Privacy Shield Frameworks, GDPR, Guidelines for Law Enforcement, HIPAA, MSA, Opt-In Policy, Opt-Out Policy, Privacy Policy, Push Notification Policy, Spam Abuse, Swiss-U.S. Privacy Shield Frameworks, Terms and Conditions etc.</td>
        ...
        <tr>
          ...
          <td><h1><a href="https://github.com/summercms/sc-protocol-module">Protocol Module</a></h1><br>Intergrated features including HTTPS, Mixed Content, HTTP/1.1, HTTP/2 and Server Push, QUIC and HTTP/3, Early Hints API, IPFS, Preloading, Predictive prefetching etc.</td>
        </tr>
        <tr>
